...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>oiv_scheidingen</se:Name>
    <UserStyle>
      <se:Name>OIV Scheidingen</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>bouwdeel_scheiding</se:Name>
          <se:Description>
        ...
        <se:Rule>
          <se:Name>rookwerende_scheiding</se:Name>
          <se:Description>
        ...
        <se:Rule>
          <se:Name>30_min_brandwerende_scheiding</se:Name>
          <se:Description>
        ...
        <se:Rule>
          <se:Name>60_min_brandwerende_scheiding</se:Name>
          <se:Description>
        ...
        <se:Rule>
          <se:Name>120_min_brandwerende_scheiding</se:Name>
          <se:Description>
        ...
        <se:Rule>
          <se:Name>blusleiding_bouwlaag</se:Name>
          <se:Description>
            <se:Title>blusleiding_bouwlaag</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>soort</ogc:PropertyName>
              <ogc:Literal>blusleiding_bouwlaag</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:MinScaleDenominator>1</se:MinScaleDenominator>
          <se:MaxScaleDenominator>5000</se:MaxScaleDenominator>
        ...
        <se:Rule>
          <se:Name>contouren_bouwlaag</se:Name>
          <se:Description>
            <se:Title>contouren_bouwlaag</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>soort</ogc:PropertyName>
              <ogc:Literal>contouren_bouwlaag</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:MinScaleDenominator>1</se:MinScaleDenominator>
          <se:MaxScaleDenominator>5000</se:MaxScaleDenominator>
        ...
        <se:Rule>
          <se:Name>hulplijn_bouwlaag</se:Name>
          <se:Description>
            <se:Title>hulplijn_bouwlaag</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>soort</ogc:PropertyName>
              <ogc:Literal>hulplijn_bouwlaag</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:MinScaleDenominator>1</se:MinScaleDenominator>
          <se:MaxScaleDenominator>5000</se:MaxScaleDenominator>
