...
<qgis version="2.14.11-Essen" minimumScale="1" maximumScale="2500" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="RelationReference" name="object_id">
      <widgetv2config OrderByValue="0" fieldEditable="1" ShowForm="0" Relation="vlakken_object_rel" ReadOnly="0" MapIdentification="1" labelOnTop="0" AllowNULL="0"/>
    </edittype>
    ...
    <edittype widgetv2type="ValueRelation" name="vlakken_type_id">
      <widgetv2config OrderByValue="1" AllowNull="0" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="id" Layer="vlakken_type20170516155623690" Value="naam" labelOnTop="0" AllowMulti="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="vlakken_type_id" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="1" label="Bijzondere ruimte"/>
      <category render="true" symbol="1" value="2" label="Tijdelijke BAG"/>
      <category render="true" symbol="2" value="3" label="Verkeersruimte"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="255,249,122,255"/>
  ...
  <editforminitfilepath>./ui/vlakken.py</editforminitfilepath>
