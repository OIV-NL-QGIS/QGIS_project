    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Bijzondere ruimte</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>vlakken_type</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Tijdelijke BAG</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>vlakken_type</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Verkeersruimte</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>vlakken_type</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>Overige ruimte</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>vlakken_type</ogc:PropertyName>
