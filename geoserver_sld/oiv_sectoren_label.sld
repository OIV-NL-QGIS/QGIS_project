  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <!-- Drassig terrein niet berijdbaar -->
        <se:Rule>
          <se:Name>Drassig terrein niet berijdbaar</se:Name>
        ...
        <!-- Ecologisch kwetsbaar terrein -->
        <se:Rule>
          <se:Name>Ecologisch kwetsbaar terrein</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>soort</ogc:PropertyName>
        ...
        <!-- Gevaarlijk terrein nooit te betreden -->
        <se:Rule>
          <se:Name>Gevaarlijk terrein nooit te betreden</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>soort</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            ...
            <se:Stroke>
              <se:SvgParameter name="stroke">#024dc0</se:SvgParameter>
        ...
        <!-- Terrein niet-begaanbaar -->
        <se:Rule>
          <se:Name>Terrein niet-begaanbaar</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>soort</ogc:PropertyName>
