  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <!-- 120 min brandwerende scheiding -->
        <se:Rule>
        ...
        <!-- Bouwdeelscheiding -->
        <se:Rule>
          <se:Name>Bouwdeelscheiding</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>soort</ogc:PropertyName>
        ...
        <!-- Rookwerendescheiding -->
        <se:Rule>
          <se:Name>Rookwerendescheiding</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>soort</ogc:PropertyName>
