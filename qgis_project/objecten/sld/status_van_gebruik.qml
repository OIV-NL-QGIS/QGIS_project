...
<qgis version="2.18.24" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="status" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="" label="geen status"/>
      <category render="true" symbol="1" value="in gebruik" label="in gebruik"/>
      <category render="true" symbol="2" value="concept" label="concept"/>
      <category render="true" symbol="3" value="archief" label="archief"/>
    </categories>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="formelenaam" index="1" name="Formelenaam"/>
    <alias field="pand_id" index="2" name=""/>
    <alias field="datum_aangemaakt" index="3" name="Datum laatste "/>
    <alias field="datum_gewijzigd" index="4" name=""/>
